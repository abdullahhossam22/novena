...
@section('title') Novena- Health Care @endsection
			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="{{route('appoinment.create')}}" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Make appoinment <i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<a href="{{route('appoinment.create')}}" class="btn btn-main btn-round-full">Make a appoinment</a>
					</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-4">
				<div class="about-content pl-4 mt-4 mt-lg-0">
					...
					<a href="{{route('service.index')}}" class="btn btn-main-2 btn-round-full btn-icon">Services<i class="icofont-simple-right ml-3"></i></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-10 ">
				<div class="appoinment-wrap mt-5 mt-lg-0">
				    ...
				    <form id="#" class="appoinment-form" method="post" action="{{route('appointment.store')}}">
					@csrf
                    <div class="row">
                         <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <select class="form-control" id="exampleFormControlSelect2">
                                  ...
                                  <option value="Abdullah Hossam">abdullah hossam</option>
					...
					<input class="btn btn-main btn-round-full" type="submit" value="Make appointment"><i class="icofont-simple-right ml-2"></i></input>
                </form>
            </div>
			</div>
		</div>
